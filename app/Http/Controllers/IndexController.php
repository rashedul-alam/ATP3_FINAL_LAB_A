...
class IndexController extends Controller
{
    public function index(){
    	...
    	// Get all Products
    	$productsAll = Product::inRandomOrder()->where('status',1)->paginate(3);
    	...
    	return view('index')->with(compact('productsAll','categories_menu','categories','meta_title','meta_description','meta_keywords'));
    }
}
